export default {
  ...
  fields: [
          ...
          fields: [
            {
              ...
              to: [{ type: "actor" }],
              description:
                "Actor in the movie, select an existing actor from the list or add a new actor"
            },
            {
              name: "role",
              title: "Role",
              type: "string",
              description:
                "The role played by the actor in this movie"
            }
          ]
        }
      ]
    ...
    },
    {
      ...
      type: "number",
      description:
        "Box office collection of the movie in USD millions"
    },
    {
      name: "duration",
      title: "Duration",
    ...
    },
    {
      ...
      description: "",
      validation: Rule =>
        Rule.required().error("A review must have an Amazon link")
    },
    {
      name: "content_type",
      title: "Content Type",
      ...
      validation: Rule =>
        Rule.required().error("Please select a content type")
    },
    {
      name: "amazonAsins",
      title: "Amazon ASINs",
